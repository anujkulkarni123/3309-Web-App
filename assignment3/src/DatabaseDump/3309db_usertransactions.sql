...
CREATE TABLE `usertransactions` (
  ...
  KEY `BuyerID` (`BuyerID`),
  CONSTRAINT `usertransactions_ibfk_1` FOREIGN KEY (`ToolID`) REFERENCES `tools` (`ToolID`) ON DELETE CASCADE,
  CONSTRAINT `usertransactions_ibfk_2` FOREIGN KEY (`SellerID`) REFERENCES `users` (`UserID`) ON DELETE CASCADE,
  CONSTRAINT `usertransactions_ibfk_3` FOREIGN KEY (`BuyerID`) REFERENCES `users` (`UserID`) ON DELETE CASCADE
